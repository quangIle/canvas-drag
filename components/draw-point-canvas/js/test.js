    ...
    var SignaturePad = (function () {
      function SignaturePad(canvas, options) {
        ...
        this._handleMouseMove = function (event) {
          if (_this._isDrawingLine) return
      ...
      SignaturePad.prototype.drawLine = function () {
        this._isDrawing = true
      ...
      SignaturePad.prototype.undo = function () {
        ...
        if (this._startingSignature) {
          this.fromDataURL(this._startingSignature, {}, () =>
      ...
      SignaturePad.prototype.fromDataURL = function (
        ...
        image.onload = function () {
          ...
          _this._ctx.globalCompositeOperation = _this._isDrawing
            ? "source-over"
            : "destination-out"
          if (callback) {
            callback()
      ...
      SignaturePad.prototype.toDataURL = function (
        ...
        return type === "image/svg+xml"
          ? this._toSVG()
          : this.canvas.toDataURL(type, encoderOptions)
      }
      ...
      SignaturePad.prototype.fromData = function (
        ...
        if (pointGroups && pointGroups.length > 0) {
          this._fromData(
            ...
            ({ color, point, dotSize }) =>
              _this._drawDot({ color, point, dotSize })
          )
      ...
      SignaturePad.prototype._strokeBegin = function (event) {
        ...
        if (this._isDrawingLine) this._lineHasStartPoint = true
      }
      SignaturePad.prototype._strokeUpdate = function (event) {
        ...
        if (!lastPoint || !(lastPoint && isLastPointTooClose)) {
          ...
          if (this._lineHasStartPoint) curve = this._addPoint(point)
          ...
          if (curve) this._lineHasStartPoint = false
        }
      }
      ...
      SignaturePad.prototype._addPoint = function (
        ...
        if (_lastPoints.length > 2) {
          ...
          var widths = {
            ...
            start: minWidth,
          } // this._calculateCurveWidths(_lastPoints[1], _lastPoints[2], minWidth, maxWidth);
      ...
      SignaturePad.prototype._strokeWidth = function (
        velocity,
        minWidth = this.minWidth,
        maxWidth = this.maxWidth
      ) {
      ...
      SignaturePad.prototype._drawCurve = function (_a) {
        ...
        var drawSteps = Math.floor(curve.length()) * 2.5
        ctx.beginPath()
        ctx.fillStyle = color
      ...
      SignaturePad.prototype._fromData = function (
        ...
        this._ctx.globalCompositeOperation = this._isDrawing
          ? "source-over"
          : "destination-out"
      }
